...
md::delete_database(con_md,"vignette")
...
Notice that we don't assign this object to anything, this just silently writes our data to our database and prints a message confirming the performed actions as well as some summary of catalogs, schemas, tables and shares that you havea access
...
```{r}
#| label: list-all-tables-1-hidden
#| echo: false
#| eval: true
#| warning: false
#| message: true
